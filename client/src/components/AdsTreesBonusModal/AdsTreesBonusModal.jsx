...
import './AdsTreesBonusModal.css';

export const AdsTreesBonusModal = ({
    bonusSubtitle = 'You have planted',
    bonusLabel = '8 videos today',
    bonusLabel2 = '+ 4 more trees',
    bonusTitle = 'Bonus!',
    className,
    ...props
}) => {
    return (
        <div className={'ads-trees-bonus-modal ' + className}>
            <div className="bonus-modal-header">
                <div className="bonus-title">{bonusTitle} </div>
                <div className="bonus-frame">
                    <svg
                        className="star"
                        width="17"
                        height="16"
                    ...
                    >
                        <path
                            d="M8.5 0.380981L11.1667 5.33336L16.5 6.09527L12.6905 9.90479L13.4524 15.6191L8.5 12.9524L3.54762 15.6191L4.30952 9.90479L0.5 6.09527L5.83333 5.33336L8.5 0.380981Z"
                            fill="#FFE999"
                        />
                        <path
                            d="M8.5 8.38098L11.1667 5.33336L8.5 0.380981V8.38098ZM16.5 6.09527L8.5 8.38098L12.6905 9.90479L16.5 6.09527ZM13.4524 15.6191L8.5 8.38098V12.9524L13.4524 15.6191ZM4.30952 9.90479L3.54762 15.6191L8.5 8.38098L4.30952 9.90479ZM0.5 6.09527L8.5 8.38098L5.83333 5.33336L0.5 6.09527Z"
                            fill="#FFC662"
                        />
                    </svg>

                    <div className="bonus-label-frame">
                        <div className="bonus-label">{bonusLabel} </div>
                    </div>
                </div>
                <div className="bonus-subtitle">{bonusSubtitle} </div>
            </div>
            <div className="bonus-modal-body">
                <div className="bonus">
                    ...
                    <div className="bonus-label2">{bonusLabel2} </div>
                </div>
            </div>

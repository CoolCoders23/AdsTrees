                    ...
                    <div className="client-video-interaction-frame">
                        ...
                        <div className="client-video-interaction-subframe">
                            <div className="video-player-frame">
                                ...
                                {currentVideo && (
                                    <div style={{
                                        border: '2px solid rgba(159, 178, 172, 0.2)',
                                        borderRadius: '10px',
                                        overflow: 'hidden',
                                        marginBottom: '10px',
                                    }}>
                            ...
                            <div className="client-controllers-frame">
                                ...
                                <div className="client-controllers">
                                    ...
                                    <Collapse
                                        in={isOpen}
                                        transition={
                                            { exit: { delay: 1 }, enter: { duration: 0.5 } }
                                        }
                                        style={{ width: '100%' }}
                                    >
                                        <Box
                                            ...
                                            rounded='md'
                                            shadow='md'
                                            className="dashboard-info-box"
                                        >
                                            <div className="reward-frame">
                                                <div>
                                                    <p className="reward-label">Note that you have to watch the video until the end to count it as a watched video and get the reward.</p>
                                                </div>
                                                <div className="reward-frame-planted">
                                                    ...
                                                    <p className="reward-label">
                                                        x{plantedTreesByWatching} tree will be planted after you watch this video.{' '}
                                                    </p>
                                                </div>
                                            </div>
                                        </Box>
                            ...
                            {userData && userData.user && (
                                <div className="bonus-holder-frame">
                                    <div className="bonus-holder-subframe-1-a">
                                        <BonusCard
                                            key={userData.user.watchedInMonth}
                                            reward="x 16"
                                        ...
                                        />
                                        <BonusCard
                                            key2={userData.user.watchedInWeek}
                                            reward="x 8"
                                    ...
                                    <div className="bonus-holder-subframe-1-b">
                                        <BonusCard
                                            key3={userData.user.watchedToday}
                                            reward="x 4"
                                        ...
                                        />
                                        <BonusCard
                                            key4={userData.user.watchedToday}
                                            reward="x 2"
